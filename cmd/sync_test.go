...
func Test_sync(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			yes:       true,
			wantRepo:  map[string]string{"dot_zshrc": "new"},
		...
		},
		{
			...
			yes:       true,
			wantRepo:  map[string]string{"dot_config/nvim/init.lua": "lua"},
		...
		},
		{
			...
			wantRepo:  map[string]string{"dot_zshrc": "same"},
		...
		{
			name:      "apply ignores dot-prefixed files in repo",
			act:       apply,
			repoFiles: map[string]string{"dot_zshrc": "new", ".gitignore": "x"},
			homeFiles: map[string]string{".zshrc": "old"},
			yes:       true,
			wantRepo:  map[string]string{"dot_zshrc": "new", ".gitignore": "x"},
			wantHome:  map[string]string{".zshrc": "new"},
		},
		{
		...
		},
		{
			...
			act:       update,
			repoFiles: map[string]string{"dot_zshrc": "x", "dot_vimrc": "old"},
			homeFiles: map[string]string{".vimrc": "new"},
			wantRepo:  map[string]string{"dot_zshrc": "x", "dot_vimrc": "new"},
...
func Test_changedFiles(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			act:       apply,
			repoFiles: map[string]string{"dot_zshrc": "new", "dot_vimrc": "same", "dot_gitconfig": "git"},
			homeFiles: map[string]string{".zshrc": "old", ".vimrc": "same"},
			want:      []string{"dot_gitconfig", "dot_zshrc"},
		},
		{
